...
const logs = {
  [dfoAddressLog0.address]: [dfoAddressLog0],
  [dfoAddressLog1.address]: [dfoAddressLog1],
  [dfoAddressLog2.address]: [dfoAddressLog2],
  [dfoAddressLog3.address]: [dfoAddressLog3],
  [dfoAddressLog4.address]: [dfoAddressLog4],
}
